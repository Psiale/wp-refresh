...
add_action('wp_enqueue_scripts', '_ft_ale_dev_scripts_styles');
function _ft_ale_dev_scripts_styles() {
  $theme = wp_get_theme();
  wp_enqueue_style(
    'ft-ale-dev-theme',
...
add_action('wp_enqueue_scripts', '_ft_ale_dev_fonts');
add_action('admin_init', '_ft_ale_dev_fonts');
function _ft_ale_dev_fonts() {
  $theme = wp_get_theme();
  wp_enqueue_style(
    'font-catamaran',
